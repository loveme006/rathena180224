...
// For more information, see LICENCE in the main folder
	...
	export_constant(RDMOPTG_Vicious_Mind_Atk1);
	export_constant(RDMOPTG_Vicious_Mind_Atk2);
	export_constant(RDMOPTG_Vicious_Mind_Atk3);
	export_constant(RDMOPTG_Vicious_Mind_Matk1);
	export_constant(RDMOPTG_Vicious_Mind_Matk2);
	export_constant(RDMOPTG_Vicious_Mind_Matk3);
	...
	export_constant(Costume_Enchantement_Stone1);
	export_constant(Costume_Enchantement_Stone2);
	export_constant(Costume_Enchantement_Stone3);
	export_constant(Costume_Enchantement_Stone4);
	export_constant(Costume_Enchantement_Stone5);
	export_constant(Costume_Enchantement_Stone6);
