...
int mail_openmail(struct map_session_data *sd)
{
	...
	intif_Mail_requestinbox(sd->status.char_id, 3, MAIL_INBOX_NORMAL);
	clif_Mail_refreshinbox(sd, MAIL_INBOX_ACCOUNT, 0);
	intif_Mail_requestinbox(sd->status.char_id, 3, MAIL_INBOX_ACCOUNT);
